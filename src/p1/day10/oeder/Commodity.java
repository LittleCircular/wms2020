...
public class Commodity {
	...
	private static Commodity[] commodities = new Commodity[50];
	private static int num = 0 ;//商品数量
	 ...
	 * 添加商品
	 */
	public static void setCommodity(Commodity com) {
	 ...
	 * 显示商品
	 */
	public static void getCommodity() {
		for (int i = 0; i < commodities.length; i++) {
			System.out.println(commodities[i]);
		}
	}
